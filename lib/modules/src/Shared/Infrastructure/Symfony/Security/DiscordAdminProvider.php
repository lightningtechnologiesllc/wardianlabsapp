...
final class DiscordAdminProvider implements UserProviderInterface, PasswordUpgraderInterface
{
    ...
    public function refreshUser(UserInterface $user): UserInterface
    {
        ...
        return $this->userRepository->findOneByDiscordId($user->getDiscordId()) ?? throw new UserNotFoundException();
    }
