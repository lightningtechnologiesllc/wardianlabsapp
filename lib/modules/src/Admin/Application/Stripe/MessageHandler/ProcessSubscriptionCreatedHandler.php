...
final readonly class ProcessSubscriptionCreatedHandler
{
    public function __construct(
        ...
        private StripeClient $platformStripeClient,
    ...
    public function __invoke(ProcessSubscriptionCreatedMessage $message): void
    {
        ...
        // Fetch customer email - this will throw if customer not found, triggering retry
        $customer = $this->platformStripeClient->customers->retrieve($customerId);
